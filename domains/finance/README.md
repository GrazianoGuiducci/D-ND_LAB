...
> Status: **alpha** · Generated by meta-lab cycle `20260505_1205` · TEMPLATE_VALID M1-M7 after transduction retrofit
...
- [x] Template validato (M1-M7, strict M7 PASS)
...
- `domains/meta-lab/tools/lab_template_validator.py` — falsifier meta M1-M7
- `domains/finance/transduction.md` — nota M7 di transduzione dominio

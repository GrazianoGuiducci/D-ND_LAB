...
Applica le meta-lenti M1-M9 (definite in domains/meta-lab/assertions.py)
...
def main():
    ...
    ap.add_argument("--strict-m7", action="store_true",
                    help="rende M7/M8 bloccanti per nuovi template senza transduction.md o skill retrieval")
